Namespace ExportReportDemo.Module.Win
    Partial Public Class ExportReportDemoWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' ExportReportDemoWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(ExportReportDemo.Module.ExportReportDemoModule))
