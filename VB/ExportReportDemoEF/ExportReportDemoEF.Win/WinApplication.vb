...
Namespace ExportReportDemoEF.Win
    ...
    Partial Public Class ExportReportDemoEFWindowsFormsApplication
        ...
        Protected Overrides Sub CreateDefaultObjectSpaceProvider(ByVal args As CreateCustomObjectSpaceProviderEventArgs)
            If args.Connection IsNot Nothing Then
                args.ObjectSpaceProvider = New EFObjectSpaceProvider(GetType(ExportReportDemoEFDbContext), TypesInfo, Nothing, CType(args.Connection, DbConnection))
            Else
