Namespace ExportReportDemoEF.Module.Win
    Partial Public Class ExportReportDemoEFWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' ExportReportDemoEFWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(ExportReportDemoEF.Module.ExportReportDemoEFModule))
